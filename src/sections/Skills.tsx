...
export default function Skills() {
  return (
    <ThemedContentBox className='text-center text-white max-w-xl mx-auto'>
      ...
      <h1 className='text-3xl md:text-5xl font-press-start mb-8 text-outline-black'>
        Skills
      </h1>
      <div className="max-h-[50vh] overflow-y-auto px-2">
        <ul className='flex flex-wrap gap-4 justify-center pb-4'> {/* Added pb-4 for spacing at the bottom of scroll */} 
        {skills.map((skill) => (
          <li
            key={skill}
